package com.lgu.ccss.common.dataaccess.util;
...
public class CamelUtil {
    ...
    /**
     * underscore ('_') 가 포함되어 있는 문자열을 Camel Case ( 낙타등 표기법 - 단어의 변경시에 대문자로 시작하는
     * 형태. 시작은 소문자) 로 변환해주는 utility 메서드 ('_' 가 나타나지 않고 첫문자가 대문자인 경우도 변환 처리 함.)
