...
jui.define("chart.brush.pie", [ "util.base", "util.math", "util.color" ], function(_, math, ColorUtil) {
    ...
    var PieBrush = function() {
    	var pathLocationLeftNum = 0;
    	var pathLocationRightNum = 0;
        ...
        this.drawText = function(centerX, centerY, centerAngle, outerRadius, text) {
            ...
            if(this.brush.showText == "inside") {
				...
				preRate = rate - (rate * 0.076);
				if(isLeft){
					var tick = rate * 0.17 * pathLocationLeftNum;
					preRate += tick;
					preOpacity = 1;
					pathLocationLeftNum++;
				} else {
					var tick = rate * 0.17 * pathLocationRightNum;
					preRate += tick;
					preOpacity = 1;
					pathLocationRightNum++;
				}
