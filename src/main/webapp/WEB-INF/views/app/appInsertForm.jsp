...
function appInsert() {
	...
	var url = "<c:url value='/app/insertNewApp.do' />";
...
<div class="contents_wrap">
	<form id="appInsertForm" name="appInsertForm">
		<div class="main_top">
			<h2> 전시관리 > App 버전 관리 > App 버전 등록</h2>
		</div>
			...
			<table class="table simple table_write_type">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3" class="last">
							<input type="text" onkeydown="notAvailableSpecialChar(this)" autocomplete="off" id="appNm" name="appNm"  class="input w01" />
						</td>
					</tr>
					<tr>
						<th>App 버전 <span class="imp">*</span></th>
						<td colspan="3" class="last">
							<input type="text" onkeydown="isVersion(this)" autocomplete="off" id="appVer" name="appVer" class="input w01" />
						</td>
					</tr>
					<tr>
						<th>App 파일명 <span class="imp">*</span></th>
						<td colspan="3" class="last">
							<input type="text" onkeydown="notAvailableSpecialChar(this)" autocomplete="off" id="appFileNm" name="appFileNm"  class="input w01" />
						</td>
					</tr>
					<tr>
						<th>APP 마켓 URL <span class="imp">*</span></th>
						<td colspan="3" class="last">
							<input type="text" onkeydown="isURL(this)" autocomplete="off" id="appMarketUrl" name="appMarketUrl"  class="input w01"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3" class="last">
							<textarea id="appCont" name="appCont" class="input textareabox" style="height:200px"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
