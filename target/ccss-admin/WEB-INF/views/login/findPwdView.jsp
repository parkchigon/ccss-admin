...
<script type="text/javaScript">
	...
	function checkFindPwd(){
		var valChk = true;
		$("#mngrId, #mngrName, #emailAddr").each(function() {
			if($.trim($(this).val()) == ""){
	...
	function excuteFindPwd(){
		$.ajax({
			...
			,data: { 	mngrId   :  $("#mngrId").val()
					  , mngrName :  AES_Encode($("#mngrName").val())   //이름
	...
	<div class="login_form_in_wrap">
		<div class="login_form">
			<div class="userlogin_form">
				...
				<div class="detail">
					<div class="user">
						<input type="text" value='admin' class="input w01" placeholder="아이디" id="mngrId" name="mngrId" onkeydown="if(event.keyCode==13) checkFindPwd();"/>
						<input type="text" value='마스터' class="input w01" placeholder="이름" id="mngrName" name="mngrName" onkeydown="if(event.keyCode==13) checkFindPwd();"/>
						<input type="text" value='yd1505@feelingk.com' class="input w01" placeholder="E-MAIL" onkeydown="if(event.keyCode==13) excuteFindPwd();" id="emailAddr" name="emailAddr" />
					</div>
					<div class="btn_login">
