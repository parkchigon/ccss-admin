...
<script type="text/javaScript">
	...
	function checkFindId(){
		var valChk = true;
		$("#mngrName, #emailAddr").each(function() {
			if($.trim($(this).val()) == ""){
	...
	function excuteFindId(){
		$.ajax({
			...
			,data: { 	mngrName :  AES_Encode($("#mngrName").val())
	...
	<div class="login_form_in_wrap">
		<div class="login_form">
			<div class="userlogin_form">
				...
				<div class="detail">
					<div class="user">
						<input type="text" class="input w01" placeholder="이름" id="mngrName" name="mngrName" onkeydown="if(event.keyCode==13) checkFindId();"/>
