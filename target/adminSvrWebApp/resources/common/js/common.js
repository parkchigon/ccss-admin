...
//특문 제한
/*function restrictionsSC(id,attr){
	var hangul = attr.hangul;
	var alphabet =attr.english;
	var specialChar =attr.specialChar;
	var num = attr.num;
...
function datePicker(attrs) {
	...
	var defaultDt = attrs.defaultDt;
	
	if(!defaultDt){
		
		defaultDt = dateAdd(new Date().toISOString().slice(0,10),0,"d");
	}else{
